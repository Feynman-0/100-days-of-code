...
body.style.backgroundImage = 'url("https://wallpaperaccess.com/full/1249336.jpg")';
const jokes = [
...
let getRandomelement = () => {
  arr = jokes[Math.floor(Math.random() * jokes.length)]

  document.getElementById("random-joke").innerHTML = arr
}